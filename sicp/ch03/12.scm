...
;; append creates a new list which contains the elements of both x and y by copying the elements
;;
;;       +---+---+    +---+---+
;; x --> | . | -----> |   | / |
;;       +-|-+---+    +-|-+---+
...
;; append! modifies the last pair of x and b is no longer the last element
;; 
;; w ------+
;;         |
;;         v
