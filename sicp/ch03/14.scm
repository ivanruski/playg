...
;; the box-and-pointer diagram that represents the list to which v is
...
;; mystery is doing a in-place reverse of a list - it changes the pointers of
;; the existing pairs to point to the previous

;; before evaluating (mystery v)
;;
;;       +---+---+    +---+---+    +---+---+    +---+---+
;; v --> | . | -----> | . | -----> | . | -----> | . | / |
;;       +-|-+---+    +-|-+---+    +-|-+---+    +-|-+---+
